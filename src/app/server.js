...
var message = process.env.MESSAGE || 'Canary Deployment using Nginx Ingress Controller';
...
var containerImage = process.env.CONTAINER_IMAGE || 'Abhinav-26/hello-k8s:' + applicationVersion
